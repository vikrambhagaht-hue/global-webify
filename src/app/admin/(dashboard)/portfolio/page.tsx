    ...
    return new Promise((resolve, reject) => {
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          // Instantly convert to WebP to drastically reduce file size
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          ...
          {items.length === 0 && (
            <div className="col-span-full bg-gray-50 border border-dashed border-gray-300 rounded-xl p-12 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">No portfolio items yet</h3>
              <p className="text-gray-500">Click "Add New Project" to capture your first website screenshot.</p>
            </div>
          )}
        </div>
      )}
            ...
            <form onSubmit={handleSave} className="p-6 space-y-6">
              ...
              <label className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">This will display the project on the homepage's 6-card grid.</div>
                </div>
              </label>
