...
export const defaultContactInfo: ContactInfo = {
  ...
  marqueeText: 'Global Webify is a trusted Website Designer in Ranchi, Jharkhand delivering creative, user-friendly websites for all industries with proven strategies and expert SEO services.',
  socials: {
