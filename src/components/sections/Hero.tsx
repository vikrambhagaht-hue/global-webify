...
// TypingHeadline moved to separate component to isolate re-renders
...
const badges = [
  ...
  { title: "Meta Ad Partner", sub: "4.5 Rating", icon: <img src="/meta-icon.svg" alt="Meta Ad Partner" title="Meta Ad Partner" width="32" height="32" className="object-contain" /> },
  { title: "ISO Certified", sub: "ISO 9001:2015", icon: <Image src="/iso.png" alt="ISO" title="ISO" width={34} height={34} className="object-contain" style={{ width: 'auto', height: 'auto' }} /> },
  { title: "AI Powered", sub: "Intelligent Solutions", icon: <Image src="/artificial-intelligence.png" alt="AI" title="AI" width={34} height={34} className="object-contain" style={{ width: 'auto', height: 'auto' }} /> },
];
...
export default function Hero({ 
  ...
  return (
    <section className="w-full relative overflow-hidden bg-white font-jost text-left">
      {/* Background Pattern - Optimized for instant LCP using Next.js Image priority */}
